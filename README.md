[![IT Shark](https://avatars2.githubusercontent.com/u/34164782?s=200&v=4)](http://Temprain/)
# Brest IT Shark School
## Javascript Assignments  [![Build Status](https://travis-ci.org/Temprain/js-assignments.svg?branch=master)](https://travis-ci.org/Temprain/js-assignments)
...
* Push your updates to github server and check if tests passed on [travis-ci](https://travis-ci.org/Temprain/js-assignments/builds).
